...
def main():
    ...
    outFile = os.path.join(scriptDir,'NREL_5MW_Main.outb')
    ...
    fstFile = os.path.join(scriptDir,'NREL_5MW_Main.fst')
    ...
    # ax.plot(dfRad_AD['r/R_[-]'].values, dfRad_AD['B1Ft_[N/m]'].values/dfRad_AD['B1Cl_[-]'].max()  , label='Lift coefficient (AeroDyn)')
