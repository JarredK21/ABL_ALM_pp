...
for offset in offsets:
    ...
    plt.plot(Time_OF[idx1:T_end],IyB[:T_end],"-b",label="Blade asymmetry\nfrom actuator data")
    plt.xlabel("Time [s]")
    ...
    cc = round(correlation_coef(Iz[idx1:],IzB[:T_end]),2)
    fig = plt.figure(figsize=(14,8))
    plt.plot(Time_OF[idx1:],Iy[idx1:],"-r",label="Blade asymmetry\nfrom planar data")
    plt.plot(Time_OF[idx1:T_end],IzB[:T_end],"-b",label="Blade asymmetry\nfrom actuator data")
    plt.xlabel("Time [s]")
    ...
    cc = round(correlation_coef(I[idx1:],IB[:T_end]),2)
    fig = plt.figure(figsize=(14,8))
    plt.plot(Time_OF[idx1:],I[idx1:],"-r",label="Blade asymmetry\nfrom planar data")
    plt.plot(Time_OF[idx1:T_end],IB[:T_end],"-b",label="Blade asymmetry\nfrom actuator data")
    plt.xlabel("Time [s]")
