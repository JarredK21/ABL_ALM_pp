...
##final edits change indir to current dir, change tstart and tend, change stats file, make folder to save plots
...
for offset in offsets:
    ...
    plt.grid()
    plt.tight_layout()
    plt.savefig("../../ABL_precursor_2_restart/Eddy_length_{}m.png".format(height))
    plt.close()